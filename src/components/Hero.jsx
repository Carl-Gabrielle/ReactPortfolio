...
export default function Hero() {
    ...
    const StatisticCard = ({ number, description, isLast }) => (
        <div className={`px-8 sm:px-12 lg:px-16 flex flex-col items-center border-gray-400 ${!isLast ? 'sm:border-r-2' : ''}`}>
    ...
    return (
        <section className="w-full h-full px-4 lg:px-10 py-10 md:py-11">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center w-full py-12 ">
                <div className="flex justify-center order-1 md:order-2 w-full relative">
                    <div className='hidden sm:block absolute z-20 bg-white bg-opacity-60 backdrop-blur-md shadow-md border  border-zinc-300 px-4 rounded-xl -top-3 left-20 -rotate-12 '>
